...
void test_EmitSignal(GDBusProxy *proxy)
{
	...
	id = g_dbus_connection_signal_subscribe(conn,"org.example.TestServer","org.example.TestInterface","OnEmitSignal","/org/example/TestObject",NULL, /* arg0 */G_DBUS_SIGNAL_FLAGS_NONE,on_emit_signal_callback,loop, /* user data */NULL);
	/*
