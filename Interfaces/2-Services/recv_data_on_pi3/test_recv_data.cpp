...
int main(void)
{
    ...
    while(1)
    {
        ...
        testFile << (unsigned long)((unsigned long)tv.tv_usec / 1000 + (unsigned long) tv.tv_sec * 1000) << "," << endl;
        //testFile << endl << endl << (unsigned long)((unsigned long)tv.tv_usec / 1000 + (unsigned long) tv.tv_sec * 1000) << endl;
        /* Write data to file */
        //testFile.write(data,2000);
        free(data);
    }
